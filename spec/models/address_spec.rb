...
describe Address do
  describe '#create' do
    ...
    it "is valid with a family_name, first_name, family_name_kana, first_name_kana, post_code, prefecture, city, street_number, building_name, phone_number, user_id" do
